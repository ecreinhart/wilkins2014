...
wilkins2014_raw <- read.csv("../data/wilkins & kaiser 2014 replication_November 29, 2018_10.31_anonymized.csv") 

#remove first two rows that are headers and the first 31 rows (through row 33) which are previews 
wilkins2014_formatted <- wilkins2014_raw[-(1:33),] %>% 
  select(slb_1:slb_12,awb_1:awb_8,condition,rac_prog,race,attn_check_1,attn_check_2) #select variables of interest 
