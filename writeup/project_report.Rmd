...
The materials described in the original paper or as described in detail on [Wilkins' website](http://silab.research.wesleyan.edu/research-materials/) were followed precisely unless otherwise noted. 
...
Participants answered the same follow-up distractor questions as used in the original paper after reading the article. Find the follow-up questions on the original materials posted on [Wilkins' website](http://silab.research.wesleyan.edu/research-materials/). 
...
```{r include=F}
###Data Preparationl; identify participants who cliked through the survey (waiting to hear original author's creiteria for this exclusion) 
