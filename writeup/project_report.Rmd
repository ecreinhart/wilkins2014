...
wilkins2014_raw <- read.csv("../data/wilkins & kaiser 2014 replication_October 29, 2018_00.10.csv")

#delete first two rows that are headers and not data; select variables of interest 
wilkins2014_filtered <- wilkins2014_raw[-(1:2),]
wilkins2014_selected <- wilkins2014_filtered %>% select(awb_1:condition)
...
wilkins2014_gathered = wilkins2014_selected %>% 
